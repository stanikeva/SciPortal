...
<body  onload="hideSearchBar()">
    ...
    <script>
        ...
        if (result.localeCompare("true"))
        {
            var navbarHide="<?php echo $param?>";
            if (!navbarHide.localeCompare("success"))
                navbarHide="true";
            else
                navbarHide="false";
            localStorage.setItem("navbarHidden", navbarHide);
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if (window.location.href.indexOf("#signup") > -1) {
                var mobileModal = new bootstrap.Modal(document.getElementById('signup'));
                emailShowWarning('emailUsed',true);
                mobileModal.show();
            }
        });
        ...
        document.addEventListener("DOMContentLoaded", function() {
            if (window.location.href.indexOf("#login") > -1) {
                var mobileModal = new bootstrap.Modal(document.getElementById('login'));
                emailShowWarning('combWrong',true);
                mobileModal.show();
            }
        });
